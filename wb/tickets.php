                ...
                <div class="col-12">
                    <div class="call-to-action-content text-center">
                        <div class="call-to-action-heading">
                            <h6>Avec Carnetis,</h6>
                            <h4>Vos évènements toujours prêts de chez vous!</h4>
                        </div>
                    </div>

                    <div class="ticket-btn text-center">
                        <a href="events.php" class="btn confer-btn-white-2 mt-40">Faire une réservation <i class="zmdi zmdi-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
